(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('rxjs'), require('@angular/platform-browser'), require('@angular/animations')) :
    typeof define === 'function' && define.amd ? define('angular-image-slider', ['exports', '@angular/core', '@angular/common', 'rxjs', '@angular/platform-browser', '@angular/animations'], factory) :
    (global = global || self, factory(global['angular-image-slider'] = {}, global.ng.core, global.ng.common, global.rxjs, global.ng.platformBrowser, global.ng.animations));
}(this, (function (exports, core, common, rxjs, platformBrowser, animations) { 'use strict';
    ...
    var SliderComponent = /** @class */ (function () {
        ...
        SliderComponent.prototype.ngOnInit = function () {
            ...
            this.images.forEach(function (element) {
                var safeUrl = _this.sanitizer.sanitize(core.SecurityContext.URL, element);
                _this.safeUrls.push(safeUrl);
            });
            this.imageUrls = this.safeUrls;
            if (this.autoRotate) {
                var source = rxjs.interval(this.autoRotateAfter);
                ...
                animations: [
                    animations.trigger('move', [
                        ...
                        animations.transition('left => void', [
                            animations.animate(200, animations.style({ transform: 'translateX(0)' }))
                        ]),
...
//# sourceMappingURL=angular-image-slider.umd.js.map
